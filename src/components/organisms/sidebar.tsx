...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <rect x="2" y="7" width="20" height="10" rx="2" ry="2" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
        <path d="M2 12h20" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
        <path d="M7 9h.01" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
  },
];
